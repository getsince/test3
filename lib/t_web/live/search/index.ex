defmodule TWeb.SearchLive.Index do
  use TWeb, :live_view
  ...
  defp profile(assigns), do: TWeb.ProfileLive.Index.profile(assigns)
end

defmodule TWeb.SearchLive.Index.Ctx do
  import Ecto.Query
  alias T.{Repo, Accounts.Profile, Accounts.User}
