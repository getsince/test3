defmodule APNS.Token do
  ...
  @spec current_token(String.t(), APNS.env()) :: String.t()
  def current_token(topic, env) do
    lookup_token(topic, env) || refresh_token(topic, env)
  end

  @spec lookup_token(String.t(), APNS.env()) :: String.t() | nil
  ...
  @spec refresh_token(String.t(), APNS.env()) :: String.t()
  ...
  defp generate_jwt_token(key, key_id, team_id, now \\ :os.system_time(:seconds)) do
