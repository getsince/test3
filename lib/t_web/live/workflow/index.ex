  ...
  def render(assigns) do
    ...
    <div class="p-2">
      <div class="text-center my-2">
        <button phx-click="start" class="rounded bg-green-300 text-green-700 border-green-700 border pl-1 pr-2 leading-7 font-semibold hover:bg-green-400 transition">🚀 Start FeedAI workflow</button>
      </div>
      <div>
    ...
    <div class="p-2 inline-block rounded bg-gray-200 dark:bg-gray-600">
      <div class="text-sm flex justify-between">
        <div>
          ...
          <span class="text-gray-700 dark:text-gray-300">started <span title={datetime(@id)} class="dark:text-white font-semibold"><%= ago(datetime(@id)) %></span></span>
        </div>
        <button phx-click="shutdown" phx-value-id={@id} class="ml-4 rounded bg-red-300 text-red-600 border-red-500 border px-1 leading-6 font-semibold uppercase hover:bg-red-400 transition" data-confirm={"Are you sure you want to shutdown #{@id}?"}>shutdown</button>
      </div>
      <div class="mt-2">
