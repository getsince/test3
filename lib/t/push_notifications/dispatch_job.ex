defmodule T.PushNotifications.DispatchJob do
  ...
  # TODO unite with contact_offer and save_slot_offer?
  defp handle_type("voicemail_sent" = type, args) do
    %{"match_id" => match_id, "receiver_id" => receiver_id, "caller_id" => caller_id} = args

    if alive_match(match_id) do
      if profile = profile_info(caller_id) do
        {name, gender} = profile
