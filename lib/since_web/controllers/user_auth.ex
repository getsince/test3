defmodule SinceWeb.UserAuth do
  import Plug.Conn
  ...
  def log_out_mobile_user(token, context \\ "mobile") do
    ...
    SinceWeb.Endpoint.broadcast("user_socket:#{encoded_token}", "disconnect", %{})
  ...
  def dashboard_auth(conn, _opts) do
    dashboard_auth_opts = Application.fetch_env!(:since, :dashboard)
