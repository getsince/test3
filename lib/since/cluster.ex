defmodule Since.Cluster do
  ...
  def primary_prefix do
    # TODO use cidr
    Application.fetch_env!(:since, :primary_prefix)
  end
  ...
  Runs the given MFA on a random node in primary region.
      ...
      primary_rpc(Since.Accounts, :local_create_user, [params])
      {:ok, %Since.Accounts.User{name: "John", email: "john@example.com"}}
