defmodule SinceWeb.ChannelHelpers do
  ...
  def report(socket, params) do
    ...
    case Since.Accounts.report_user(reporter.id, reported_user_id, reason) do
      :ok ->
        {:reply, :ok, socket}

      {:error, %Ecto.Changeset{} = changeset} ->
        rendered = Phoenix.View.render(SinceWeb.ErrorView, "changeset.json", changeset: changeset)
